#!/usr/bin/env pwsh
# Purpose : Generate the multi-language CI workflow from PowerShell.
# Why     : Supports developers who prefer PowerShell when scaffolding CI.
# How     : Writes a GitHub Actions matrix that auto-detects stacks and runs relevant jobs.
...
jobs:
  ...
  # (Remaining jobs mirror bash generator)
  python-test:
...
Write-Host 'Wrote .github/workflows/ci.yml'
